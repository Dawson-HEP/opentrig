...
async fn main(_spawner: Spawner) {
    ...
    // blocking is required due to Alex's FPGA code
    // // tx_dma : impl Peripheral<P = impl Channel> + 'd
    // // rx_dma : impl Peripheral<P = impl Channel> + 'd
    // Spi::new(p.SPI1, p.PIN_10, p.PIN_11, p.PIN_12, tx_dma??, rx_dma??, config);
    ...
    //root_dir.open_file_in_dir("fname", embedded_sdmmc::Mode::ReadWriteCreateOrAppend);
    // my_file.write() takes buffer &[u8]
